...
self.accel_channel_1 = 329
self.accel_channel_2 = 330
self.accel_channel_3 = 331

self.n_channels = 343  # total number of channels in the stream
...
self.path = "/mnt/hubel-data-103/Guillaume/InfraSlowRhythmLiveDetector/Code/Python/FINAL_Detector/CONFIGS/Hubel_tests/Outputs_pyDetector/Rat12-12-16"
