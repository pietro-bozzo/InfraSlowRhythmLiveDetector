...
# Duration of the sliding window used to compute the acceleration variance, the sliding window used to compute the real wake regarding the acceleration, and the threshold of real wake state (s).
...
self.path = "/home/guillaume/Documents/Tests_finaux_ISR/3007_thr_ajust/"

# Name of the main output file storing IS and wake/REM timing markers.
self.file_name = f"IS_wake_timings_classic_{timestamp}.txt"

# Name of the real-time debug log file (wake/REM events, phase transitions, etc.).
self.debug_name = f"debugTHRESHOLDS_{timestamp}.txt"
